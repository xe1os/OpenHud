...
export const Matches = () => {
  ...
  const handleBestOfClick = (type: number) => {
    setBestOfType(type);
  };

  const getButtonClasses = (type: number) => {
  ...
  return (
    <div className='size-full flex flex-col text-primary justify-center items-center gap-9'>
      <section className='relative flex flex-col w-3/4 h-1/2 justify-evenly items-center mt-5'>
        <div className='flex w-full justify-evenly items-center'>
          <div className='flex flex-col justify-center items-center gap-4'>
            <h1 className='font-bold text-2xl lg:text-5xl flex gap-4 justify-center items-center'>Team One<button></button></h1>
          ...
          <div className='flex flex-col justify-center items-center gap-4'>
            <h1 className='font-bold text-2xl lg:text-5xl flex gap-4 justify-center items-center'>Team Two<button></button></h1>
            <img className='w-[25%]' src={LogoPlaceHolder} alt='Team 2 Logo'/>
          </div>
        </div>
...
const Cards = (props: any) => {
  return (
    <div className='flex flex-col w-[80%] lg:w-56 lg:h-60 bg-white/10 gap-4 justify-center items-center backdrop-blur-sm mb-5'>
